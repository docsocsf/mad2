  ...
  pages: [
    {
      questions: [
        ...
        },
        {
          ...
          name: "interests",
          title:
          "In order to match you with fellow Freshers and Parents, we'd like to know a few things about your hobbies and interests. Please fill in the following, with 1 as having no interest whatsoever, to 5 being very strong interest. \n  \
          ...
          rows: [
            { value: "alcohol", text: "Drinking" },
            { value: "clubbing",text: "Clubbing"},
            { value: "anime",text: "Anime"},
            { value: "sports",text: "Sports"},
            { value: "cooking", text: "Cooking" },
            { value: "performingMusic",text: "Performing Music"},
